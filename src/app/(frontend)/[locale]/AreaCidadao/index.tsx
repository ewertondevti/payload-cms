...
const AreaCidadao = () => {
  ...
  return (
    <div className="container mx-auto my-32 reserved-area" style={{ padding: 50 }}>
      <section
        className="flex w-full"
        style={{ justifyContent: 'space-between', marginBottom: 150 }}
      >
        <div className="title">
          <h1>O meu registo individual</h1>
          <p className="subtitle">Os documentos de registo individual do cidadão num só lugar</p>
        </div>
        <div className="w-1/2" style={{ maxWidth: 250 }}>
          <Button
      ...
      <section style={{ marginBottom: 150 }}>
        <div className="flex row" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div
            ...
            style={{ alignItems: 'center', justifyContent: 'space-between', marginTop: -30 }}
          >
            <LinkWrapper>
              <a href={''}>{'Ver todos os documentos'}</a>
            </LinkWrapper>
            <Icon name={'agora-line-arrow-right-circle'} aria-hidden style={{ marginLeft: 10 }} />
          </div>
        </div>
      ...
      <section style={{ marginBottom: 150 }} className="user-area">
        <div className="title">
