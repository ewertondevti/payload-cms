...
export const FormBlock: React.FC<
  { id?: string; stepIndex: number; onSubmitOverride?: (data: Data) => void; showSubmitButton: boolean } & FormBlockType
> = (props) => {
  const {
    enableIntro,
    form: formFromProps,
    ...
    onSubmit = useCallback(
      async (data: Data) => {
        ...
        try {
          ...
          console.log('Mosparo response', mosparoResponse)
          const mosparoResult = await mosparoResponse.json()
          console.log('Mosparo result', mosparoResult)
