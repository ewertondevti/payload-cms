  ...
  const DUMMY_DATA: Array<any> = [
    {
      "header-1": 0,
      "header-2":
        "Mon Jan 29 2024 17:04:30 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 5,
      "header-2":
        "Thu Jan 11 2024 11:16:40 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 6,
      "header-2":
        "Thu Jan 25 2024 12:55:36 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 7,
      "header-2":
        "Sat Jan 20 2024 16:04:24 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 8,
      "header-2":
        "Sun Jan 21 2024 03:44:10 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 9,
      "header-2":
        "Thu Jan 18 2024 17:06:09 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 10,
      "header-2":
        "Thu Jan 25 2024 19:36:57 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 11,
      "header-2":
        "Wed Jan 10 2024 04:58:04 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 12,
      "header-2":
        "Fri Jan 05 2024 13:41:23 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 13,
      "header-2":
        "Thu Jan 11 2024 00:45:05 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 14,
      "header-2":
        "Thu Jan 25 2024 09:48:28 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 15,
      "header-2":
        "Mon Jan 22 2024 16:18:48 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 16,
      "header-2":
        "Wed Jan 17 2024 15:43:39 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 17,
      "header-2":
        "Fri Jan 05 2024 07:29:57 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 18,
      "header-2":
        "Sat Jan 27 2024 09:55:14 GMT+0000 (Hora padrão da Europa Ocidental)",
    ...
    },
    {
      "header-1": 19,
      "header-2":
        "Fri Jan 26 2024 13:22:46 GMT+0000 (Hora padrão da Europa Ocidental)",
      ...
      const cells = keys.map((k) => {
        ...
        return (
          <TableCell key={tcKey} headerLabel={k}>
            <a href={"/Catalogo/DetalhesServico"}>
              {k == "Estado" ? (
                <Pill
                  children={tableCellData[k]}
                  variant={tableCellData[k] == "Ativo" ? "success" : "warning"}
                />
              ) : (
                <>{tableCellData[k]} </>
              )}
  ...
  const CustomTable = (args: any = DUMMY_DATA) => {
    ...
    const applySort = (colIdx: number, order: SortOrder) => {
      ...
      setCurrentSortDescription(
        `Applying sort order ${order} via column ${headerKeys[colIdx]}`
      );
